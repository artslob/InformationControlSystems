...
/**----------------------------------------------------------------------------
                            readdip
-------------------------------------------------------------------------------
Чтение значений на dip-переключателях

Вход:       нет
Выход:      значения на dip-переключателях
Результат:  нет
Описание:   Производится доступ к dip-переключателям. В ENA записывается 0x00
			для возможности чтения данных из EXT_LO.
